...
class CidadesTableViewController: UITableViewController {
    ...
    var cities:[City] = []
    var delegate:ChooseCity?
    
    init() {
        super.init(nibName: "CidadesTableViewController", bundle: nil)
        self.title = "Cidades"
    }
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(UINib(nibName: CitiesTableViewCell.identifier, bundle: nil), forCellReuseIdentifier: CitiesTableViewCell.identifier)
    }
